...
export class SubscriptionMedicinesModalDialogComponent implements OnInit, AfterViewInit {
  ...
  constructor(public dialogReff: MatDialogRef<SubscriptionMedicinesModalDialogComponent>,
  ...
  openMedicineSpecificationDialog(medicine : Medicine): void {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      this.prescriptionService.savePrescription(medicine.id, this.selectedAppointment.patient.id,
